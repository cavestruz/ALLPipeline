...
def write_combined_fits_for_IDs( IDs_glob, IDs_directory=IDs_dir, band_directories=band_dir, combined_directory=combined_dir ) :
    band_directories = [ '/home/babyostrich/Downloads/Data_KiDS_Big.'+str(i)+'/Public/Band'+str(i)+'/' for i in range(1,5) ]
    ...
    for ID in get_IDs( IDs_directory ) :
...
if __name__ == "__main__" :
    ...
    p.map(write_combined_fits_for_IDs, range(0,11))
